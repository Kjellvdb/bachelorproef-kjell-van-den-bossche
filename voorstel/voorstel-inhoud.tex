...
\textit{Statement bias}, ook wel \textit{presentation bias} genoemd, verwijst naar het voordeliger omschrijven van bepaalde onderdelen ten koste van andere onderdelen \autocite{SaezTrumper2013}. Een mediabericht dat evenveel uitspraken bevat die in de ene richting voordelig zijn als uitspraken die in de tegenovergestelde richting voordelig zijn, kan als neutraal worden beschouwd \autocite{DAlessio2006}.
...
\begin{itemize}
    ...
    \item Een getraind classificatiemodel dat journalistieke bias in tekst kan detecteren met een hoge nauwkeurigheid, waarbij een minima\-le F1-score van 0.70 op een testset wordt verwacht.
